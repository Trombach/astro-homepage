...
period of about a year I was the ResearchHub's main developer front-end and I helped the team with releasing and
...
content is as fresh as possible. This isn't necessarily a problem, which can be solved using technology, as humans are
important for writing and updating content pages. However, a technical solution can assist content writers and managers
to identify content that requires attention.
...
using the GraphQL API and then uploading the results of the analysis to AWS S3 and Google Sheets. To make it easier for
content managers to analyse and understand the data, a Google data studio dashboard was also created.
