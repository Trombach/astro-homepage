...
<figure>
  ...
  <figcaption>
    Dashboard overview page. The green progress bars can only be rendered if
    data has been fetched and processed.
  </figcaption>
</figure>
...
<small>
  <a href="https://www.freepik.com/free-vector/illustration-clock_2606098.htm">
