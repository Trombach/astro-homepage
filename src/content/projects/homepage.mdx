...
Welcome to my personal homepage! In this article you can learn a few things about how this website was built, and what
drove my decision making.

## Quick Facts

- mostly statically built for easy caching and fast page load speeds
- uses Astro's content collections and [MDX](https://mdxjs.com/) for content
