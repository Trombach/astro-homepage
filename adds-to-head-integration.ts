// add integration file so that svelte-check doesn't complain
// https://github.com/lilnasy/gratelets/blob/main/packages/adds-to-head/integration.ts
            ...
            plugins: [
              {
                ...
                transform(code, id) {
                  ...
                  if (
                    ...
                    logger.debug(
                      `${id.slice(rootPath.length)} will now propagate assets.`,
                    );
